                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("respondenttype::text.name")
                            </th>
                            <th>
                                @lang("respondenttype::text.slug")
                            </th>
                            <th>
                                @lang("respondenttype::text.updated_at")
                            </th>
                            <th>
                                @lang("respondenttype::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("respondenttype::text.action")
                            </th>
                        </tr>
                    </thead>
