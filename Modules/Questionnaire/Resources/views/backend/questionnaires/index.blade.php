                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("questionnaire::text.name")
                            </th>
                            <th>
                                @lang("questionnaire::text.slug")
                            </th>
                            <th>
                                @lang("questionnaire::text.updated_at")
                            </th>
                            <th>
                                @lang("questionnaire::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("questionnaire::text.action")
                            </th>
                        </tr>
                    </thead>
