                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("questionnairetype::text.name")
                            </th>
                            <th>
                                @lang("questionnairetype::text.slug")
                            </th>
                            <th>
                                @lang("questionnairetype::text.updated_at")
                            </th>
                            <th>
                                @lang("questionnairetype::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("questionnairetype::text.action")
                            </th>
                        </tr>
                    </thead>
