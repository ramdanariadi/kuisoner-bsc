            ...
            <div class="row">
                <div class="col-12 col-sm-4 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->select($field_name, $field_options)->placeholder($field_placeholder)->class('form-select select2 select2-school')->attributes(["$required"]) }}
                    </div>
                </div>
                <div class="col-12 col-sm-4 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->label($field_lable, $field_name)->class('form-label')->for($field_name) }}
                        {!! field_required($required) !!}
                        {{ html()->select($field_name, $field_options)->placeholder($field_placeholder)->class('form-select select2')->attributes(["$required"]) }}
                    </div>
                </div>
            </div>
            <div class="row">
...
<script type="module">
    $(document).ready(function() {
        ...
        $('.select2-school').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ route('backend.schools.index_list') }}',
                dataType: 'json',
